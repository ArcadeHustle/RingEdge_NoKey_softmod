# Library code from - https://github.com/4144414D/pytruecrypt

# from "TrueCrypt 7.1a Source\Common\Crc.c"
def truecrypt_crc(data, crc):
...
def keyfile(password,keyfiles):
		...
		for keyfile in keyfiles:
			...
			for x in range(len(keyfiledata)):
				...
				crc = truecrypt_crc(keyfiledata[x], crc) & 0xFFFFFFFF
